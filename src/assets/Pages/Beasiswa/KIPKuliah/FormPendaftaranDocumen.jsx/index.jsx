          ...
          <div className="col-12 col-xxl-10">
            <DocumentUploadHeader />
              <form onSubmit={handleSubmit}>
                ...
                <FileUploadField label="Akte *" onChange={(e) => handleFileChange(e, "Akte")} />
                <FileUploadField label="KK *" onChange={(e) => handleFileChange(e, "KK")} />
                <FileUploadField label="Ijazah SMA *" onChange={(e) => handleFileChange(e, "Ijazah SMA")} />
                <FileUploadField label="Sertifikat Prestasi (Optional)" onChange={(e) => handleFileChange(e, "Sertifikat Prestasi")} />
